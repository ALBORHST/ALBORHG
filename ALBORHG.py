...
def subc():
   ...
   if id in ses:
   	...
   	print('هﺭﻮﺒﻟﺍ تﺎﻛﺍﺮﺘﺷﺍ تﺍﺩﺍ')


   	sys.exit()
print('ﺞﻣﺍﺮﺑ طﻮﺑﺮﻣ ﻂﺸﻧ ﺪﻴﺼﺗ هﺭﻮﺒﻟﺍ تﺍﺩﺍ')
print('ﻚﻨﻣ ﻪﻠﻜﺸﻣ تﺍﺩﺍ تﺩﺎﺻﺎﻣ اﺪﻳﺍ رﻮﺑﺯ ﺪﻴﺼﻧ تﺍﺩﺍ')
print('ﻲﻠﺒﺴﺣﺍ ﺪﻌﻗﺍ ﺖﻧﺍﻭ ﻲﺗﺎﻴﺣ ﺶﻳﺎﻋ ﻲﻧﺍ😈')

subc()

   	

print('يﺭﻮﺘﺳ هﺭﻮﺒﻟﺍ ﻦﻣ تﺍﺩﺍ ﻞﻴﻌﻔﺗ ﻢﺗ')
print(' يﺭﻮﺘﺳ هﺭﻮﺒﻟﺍ تﺍﺩﺍ ﻲﻓ ﻚﺑ ﻼﻫﺍ')
ugen = []
